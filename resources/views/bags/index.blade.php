@extends('layouts.bags.baglayout')
                    ...
                    <div class="tabbable"> <!-- Only required for left/right tabs -->
                        <ul class="nav nav-tabs">
                            @if ($message = Session::get('success'))
                                <li><a href="#tab1" data-toggle="tab">Bags</a></li>
                                ...
                                @guest
                                    @else
                                        ...
                                        @endguest
                                        @else
                                            <li class="active"><a href="#tab1" data-toggle="tab">Bags</a></li>
                                            <li><a href="#tab2" data-toggle="tab">Design</a></li>
                                            @guest
                                                @else
                            ...
                            <div class="tab-pane {{$message = Session::get('success') ? "active" : ""}}" id="tab3">
                                <div class="well" style="overflow-x: hidden;">
                                    ...
                                    {!! Form::file('image', array('class' => 'image')) !!}
                                        <input type="hidden" name="logoType" value="bag" />
                ...
                @auth
                    @if(!Auth::user()->isAdmin())
                        <form method="POST" action="{{url('orders')}}">
                            {{csrf_field()}}
                            <input id="orderType" type="hidden" class="hidden" name="orderType" value="bag">
